...
urlpatterns = [
    ...
    path('api/map_tree', main.get_map_tree, name='get_map_tree'),

    path('api/tenements/epm_granted/', main.get_epm_granted_layer, name="epm_granted"),
    path('api/tenements/epm_application/', main.get_epm_application_layer, name="epm_application"),
    path('api/tenements/epm_approaching_expiry/', main.get_epm_expiring_layer, name="epm_approaching_expiry"),

    path('api/tenements/mdl_granted/', main.get_mdl_granted_layer, name="mdl_granted"),
    path('api/tenements/mdl_application/', main.get_mdl_application_layer, name="mdl_application"),

    path('api/tenements/ml_granted/', main.get_ml_granted_layer, name="ml_granted"),
    path('api/tenements/ml_application/', main.get_ml_application_layer, name="ml_application"),
...
# TMS END POINTS
urlpatterns += [
    path('api/tms/tenement/<str:permit_state>/<str:permit_type>/<str:permit_number>', tms.tenement_endpoint, name='tenement'),
    path('api/tms/tenement/<str:permit_state>/<str:permit_type>/<str:permit_number>', tms.tenement_prospects_endpoint, name='tenement_prospects'),
]
